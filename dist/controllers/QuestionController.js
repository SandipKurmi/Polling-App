...
var _QuestionModle = _interopRequireDefault(require("../models/QuestionModle"));

var _QuestionService = _interopRequireDefault(require("../services/QuestionService"));
...
var questionService = new _QuestionService["default"](new _QuestionModle["default"]().getInstance());
var userService = new _UserService["default"](new _UserModel["default"]().getModel());

var QuestionController = /*#__PURE__*/function (_Controller) {
  _inherits(QuestionController, _Controller);

  var _super = _createSuper(QuestionController);

  function QuestionController(service, userService) {
    var _this;
  ...
  _createClass(QuestionController, [{
    ...
    value: function () {
      var _getAllQuestions = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        var response, _yield$this$userServi, data;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                _context2.next = 6;
                return this.userService.getUserSuggetions();

              case 6:
                _yield$this$userServi = _context2.sent;
                data = _yield$this$userServi.data;
...
var _default = new QuestionController(questionService, userService);
