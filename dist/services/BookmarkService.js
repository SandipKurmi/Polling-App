...
var BookmarkService = /*#__PURE__*/function (_Service) {
  _inherits(BookmarkService, _Service);

  var _super = _createSuper(BookmarkService);

  function BookmarkService(model) {
    var _this;
