  ...
  _createClass(QuestionService, [{
    ...
    value: function () {
      var _getAllQuestions = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
        var items, _items$, questions, suggestions, topQuestions;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                _items$ = items[0], questions = _items$.questions, suggestions = _items$.suggestions, topQuestions = _items$.topQuestions;
